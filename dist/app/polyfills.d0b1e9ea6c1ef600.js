    ...
    583: () => {
              ...
              try {
                ...
                e.state !== x &&
                  ...
                  (e.type == Q || (e.data && e.data.isPeriodic)
                    ...
                    : ((e.runCount = 0), this._updateTaskCount(e, -1), C && e._transitionTo(x, E, x))),
                  (U = U.parent),
                  (re = $);
              }
            }
        ...
        class v {
          constructor(T, e, r) {
            ...
            (k || (e && e._hasTaskZS)) &&
              ...
              r.onScheduleTask ||
                ((this._scheduleTaskZS = P), (this._scheduleTaskDlgt = e), (this._scheduleTaskCurrZone = this.zone)),
              r.onInvokeTask ||
                ((this._invokeTaskZS = P), (this._invokeTaskDlgt = e), (this._invokeTaskCurrZone = this.zone)),
              r.onCancelTask ||
                ((this._cancelTaskZS = P), (this._cancelTaskDlgt = e), (this._cancelTaskCurrZone = this.zone)));
          }
          fork(T, e) {
          ...
          intercept(T, e, r) {
            return this._interceptZS
              ? this._interceptZS.onIntercept(this._interceptDlgt, this._interceptCurrZone, T, e, r)
              : e;
          }
          invoke(T, e, r, k, C) {
            return this._invokeZS
              ? this._invokeZS.onInvoke(this._invokeDlgt, this._invokeCurrZone, T, e, r, k, C)
              : e.apply(r, k);
          }
          handleError(T, e) {
            return (
          ...
          invokeTask(T, e, r, k) {
            return this._invokeTaskZS
              ? this._invokeTaskZS.onInvokeTask(this._invokeTaskDlgt, this._invokeTaskCurrZone, T, e, r, k)
      ...
      const Fe = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
        ...
        Ue = function (t) {
          ...
          let n = we[t.type];
          n || (n = we[t.type] = A('ON_PROPERTY' + t.type));
          const i = this || t.target || Y,
            o = i[n];
          let c;
          return (
            je && i === _e && 'error' === t.type
              ? ((c = o && o.call(this, t.message, t.filename, t.lineno, t.colno, t.error)),
                !0 === c && t.preventDefault())
              : ((c = o && o.apply(this, arguments)), null != c && !c && t.preventDefault()),
            c
          );
        };
      function We(t, n, i) {
        ...
        const a = o.get,
          ...
          d = n.slice(2);
        let P = we[d];
        P || (P = we[d] = A('ON_PROPERTY' + d)),
          (o.set = function (v) {
            let m = this;
            !m && t === Y && (m = Y),
              m &&
                ('function' == typeof m[P] && m.removeEventListener(d, Ue),
                p && p.call(m, null),
                (m[P] = v),
          ...
          (o.get = function () {
            ...
            if (a) {
              let M = a.call(this);
              if (M) return o.set.call(this, M), 'function' == typeof v[ct] && v.removeAttribute(n), M;
            }
            return null;
          }),
          pe(t, n, o),
            ...
            (function (c) {
              'function' == typeof i[c]
                ...
                : pe(Y[t].prototype, c, {
                    set: function (a) {
                      'function' == typeof a
                        ? ((this[ne][c] = Ie(a, t + '.' + c)), le(this[ne][c], a))
                        : (this[ne][c] = a);
                    },
                    get: function () {
                      return this[ne][c];
      ...
      function lt(t, n, i) {
        ...
        o = ae(
          ...
          (a) =>
            function (p, d) {
              const P = i(p, d);
              return P.cbIdx >= 0 && 'function' == typeof d[P.cbIdx] ? Le(P.name, d[P.cbIdx], P, c) : a.apply(p, d);
            },
        );
      }
      function le(t, n) {
      ...
      Zone.__load_patch('ZoneAwarePromise', (t, n, i) => {
        const o = Object.getOwnPropertyDescriptor,
          ...
          p = i.symbol,
          d = [],
          P = !0 === t[p('DISABLE_WRAPPING_UNCAUGHT_PROMISE_REJECTION')],
          v = p('Promise'),
          m = p('then'),
          M = '__creationTrace__';
        ...
        function z(l, u, s) {
          ...
          if (l[q] === j) {
            ...
            if (u !== G && s instanceof e && s.hasOwnProperty(q) && s.hasOwnProperty(R) && s[q] !== j)
              ...
              const b = l[R];
              if (
                ((l[R] = s), l[_] === _ && u === E && ((l[q] = l[x]), (l[R] = l[J])), u === G && s instanceof Error)
              ) {
                const y = n.currentTask && n.currentTask.data && n.currentTask.data[M];
        ...
        function ee(l, u, s, f, g) {
          re(l);
          const b = l[q],
            y = b ? ('function' == typeof f ? f : H) : 'function' == typeof g ? g : K;
          u.scheduleMicroTask(
            X,
            () => {
              try {
            ...
            return new e((y, S) => {
              for (let D = 0; D < s.length; D++)
                s[D].then(
                  ...
                  (O) => {
                    b.push(O), f--, 0 === f && ((g = !0), S(new T(b, 'All promises were rejected')));
                  },
                );
            });
          }
            ...
            for (let O of u) {
              ...
              try {
                O.then(
                  ...
                  (F) => {
                    s ? ((D[V] = s.errorCallback(F)), y--, 0 === y && f(D)) : g(F);
                  },
                );
              } catch (F) {
                g(F);
          ...
          Z = function (R, _, J) {
            ...
            return (
              j &&
                'object' == typeof j &&
                j.once &&
                _[a].call(_, J.type, R.originalDelegate ? R.originalDelegate : R.callback, j),
              X
            );
          };
        function N(R, _, J) {
          ...
          const e = J
            ...
            u = function (s, f, g, b, y = !1, S = !1) {
              return function () {
                ...
                if (Pe && 'uncaughtException' === O) return s.apply(this, arguments);
                let F = !1;
                ...
                if ($)
                  for (let de = 0; de < $.length; de++)
                    if (O === $[de]) return fe ? s.call(D, O, V, se) : s.apply(this, arguments);
                ...
                for (let V = 0; V < O.length; V++) {
                  ...
                  if (C(F, y))
                    return (
                      ...
                      (F.isRemoved = !0),
                      0 === O.length &&
                        ((F.allRemoved = !0), (s[D] = null), 'string' == typeof f) &&
              ...
              c.forEach(function (m) {
                ...
                try {
                  if (Z.hasOwnProperty(m)) {
                    ...
                    N && N.value
                      ? ((N.value = t.wrapWithCurrentZone(N.value, M)), t._redefineProperty(P.prototype, m, N))
      ...
      Zone.__load_patch('util', (t, n, i) => {
        const o = He(t);
        (i.patchOnProperties = qe), (i.patchMethod = ae), (i.bindArguments = Me), (i.patchMacroTask = lt);
              ...
              if ('function' == typeof M[0]) {
                ...
                M[0] = function () {
                  try {
                    ...
                    Z.isPeriodic ||
                      ('number' == typeof Z.handleId ? delete p[Z.handleId] : Z.handleId && (Z.handleId[Re] = null));
                  }
                };
                const B = Le(n, M[0], Z, d, P);
                if (!B) return B;
          ...
          (a = ae(
            ...
            (v) =>
              function (m, M) {
                const Z = M[0];
                let N;
                'number' == typeof Z ? (N = p[Z]) : ((N = Z && Z[Re]), N || (N = Z)),
                  N && 'string' == typeof N.type
                    ? 'notScheduled' !== N.state &&
                      ((N.cancelFn && N.data.isPeriodic) || 0 === N.runCount) &&
                      ('number' == typeof Z ? delete p[Z] : Z && (Z[Re] = null), N.zone.cancelTask(N))
                    : v.apply(t, M);
              },
          ));
      }
      Zone.__load_patch('legacy', (t) => {
        ...
        Zone.__load_patch('timers', (t) => {
          const n = 'set',
            i = 'clear';
          Te(t, n, i, 'Timeout'), Te(t, n, i, 'Interval'), Te(t, n, i, 'Immediate');
        }),
        ...
        Zone.__load_patch('on_property', (t, n, i) => {
          !(function Tt(t, n) {
            if ((Pe && !Be) || Zone[t.symbol('patchEvents')]) return;
        ...
        Zone.__load_patch('customElements', (t, n, i) => {
          !(function yt(t, n) {
            ...
            (i || o) &&
              t.customElements &&
              'customElements' in t &&
              n.patchCallbacks(n, t.customElements, 'customElements', 'define', [
                'connectedCallback',
                ...
                () =>
                  function (h, I) {
                    if (!0 === n.current[j] || h[o]) return E.apply(h, I);
                    {
                      ...
                      h && !0 === h[d] && !w.aborted && Q.state === K && Q.invoke();
                    }
                  },
              ),
              G = ae(
